...
function FilterTimeRangeReport(props) {
      ...
      <div className="w-full inline-flex items-center gap-2">
        {timeRangeOptions.map((item) => (
          <button
            ...
            className={`px-2 py-0.5 text-sm rounded border border-gray-400 hover:bg-gray-100 ${
...
export default FilterTimeRangeReport;
